        ...
        <View style={{flex: 1, marginTop: 20}}>
          ...
          <View style={styles.searchSection}>
            <Icon
              ...
              size={20}
              color="#000"
              onPress={() => this.props.navigation.navigate ('ScannerScreen',{screenName: 'BaoHanh_KichHoat'})}
            />
            <TextInput
          ...
          <TextInput
            ...
            onChange={value => this.setState ({cusName: value})}
          />
          <Text style={styles.label}>Số điện thoại (*)</Text>
          <TextInput
            style={styles.textbox}
            placeholder="Số điện thoại"
            onChange={value => this.setState ({phoneNum: value})}
          />
