...
import { StyleSheet, ScrollView, View, TextInput, Button, StatusBar } from 'react-native';
import {
        ...
        <View style={styles.drawerContent}>
          ...
          <Drawer.Section style={styles.drawerSection}>
            <DrawerItem
              ...
              label="Kích hoạt bảo hành" onPress={() => { props.navigation.navigate('BaoHanh_KichHoat') }} />

            <DrawerItem
              icon={({ color, size }) => (
                <Icon name='account-search-outline' color={color} size={size} />
              )}
              label="Tra cứu bảo hành" onPress={() => { props.navigation.navigate('BaoHanh_TraCuu')}} />
          </Drawer.Section>
